...
export default function LoginPage() {
    // Step 0 = Mode Selection, Step 1 = Login Form
    const [step, setStep] = useState(0)
    const [loginMode, setLoginMode] = useState<"student" | "teacher" | "school" | null>(null)
    ...
    const handleModeSelect = (mode: "student" | "teacher" | "school") => {
        setLoginMode(mode)
        setStep(1)
    }
        ...
        <div className="space-y-6">
            <div className="text-center">
                ...
                <p className="text-white/60 text-sm">
                    {step === 0 ? "Select your login type to continue." : `Log in as a ${loginMode === 'school' ? 'School Member' : loginMode?.charAt(0).toUpperCase() + loginMode?.slice(1)!}`}
                </p>
            </div>
                ...
                {step === 0 ? (
                    ...
                    >
                        {[
                            ...
                            { id: "school", label: "Join School", icon: School, desc: "For district access" },
                        ].map((item) => (
                            <button
                                key={item.id}
                            ...
                            >
                                {isLoading ? (
                                    <>
                                        ...
                                        {loginMode === "school" ? "Joining School..." : "Signing in..."}
                                    </>
                                ) : (
                                    <>
                                        {loginMode === "school" ? "Join School" : "Sign In"}
