            ...
            <SettingsSection title="Usage Statistics" variant="slate">
                <SettingsCard variant="slate">
                    <SettingsCardContent className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            { label: "Generations", value: "Unlimited", sub: "245 used this month", color: "text-green-400" },
                            { label: "Output History", value: "Forever", sub: "Never deleted", color: "text-blue-400" },
                            { label: "Student Rooms", value: "Active", sub: "12 rooms open", color: "text-purple-400" },
                        ].map((stat, i) => (
                            <div key={i} className="space-y-2">
                                <h4 className="text-sm font-medium text-slate-400 uppercase tracking-wider">{stat.label}</h4>
